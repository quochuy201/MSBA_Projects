...
# cluster 3
rs <- sample(nrow(dfmnNCluster3), .8*nrow(dfmnNCluster3))

Training <-fulldsCluster3[rs,]
Testing <- fulldsCluster3[-rs,]

TrainingN <- dfmnNCluster3[rs,]
TestingN <- dfmnNCluster3[-rs,]
attach(TrainingN)
...
################################
actualTestPred1 <- testPred1$net.result * (max(fulldsCluster3[,'SalePrice'])-min(fulldsCluster3[,'SalePrice'])) + min(fulldsCluster3[,'SalePrice'])
...
################################
actualTestPred42 <- testPred42$net.result * (max(fulldsCluster3[,'SalePrice'])-min(fulldsCluster3[,'SalePrice'])) + min(fulldsCluster3[,'SalePrice'])
